...
import com.pengji.utils.encrypt.DES3Utils;
...
public class JFlyFoxUtils {
	...
	public static final String DEFALUT_DELFLAG = "0";
	 ...
	 * 采集者
	 */
	public static final String USER_TYPE_UPLOADER = "2";
	/**
	 * 编辑者
	 */
	public static final String USER_TYPE_EDITER = "3";
	/**
	 * 第三方用户
	 */
