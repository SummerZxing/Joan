...
package com.pengji.component.annotation;
...
public class ClassSearcher {
	...
	static{
		excludeClass.add("com.pengji.component.swagger.SwaggerManager");
	}
			...
			if (!baseDir.exists() || !baseDir.isDirectory()) {
				...
				String[] filelist = baseDir.list(new FilenameFilter() {
					public boolean accept(File dir, String name) {
						return !includeJars.contains(name) && name.contains("component");
					}
				});
				for (int i = 0; i < filelist.length; i++) {
