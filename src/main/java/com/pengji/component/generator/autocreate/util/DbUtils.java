...
import com.pengji.component.generator.autocreate.db.Column;
import com.pengji.component.generator.autocreate.db.DbDataTypesUtils;
import com.pengji.component.generator.autocreate.db.Table;
import com.pengji.component.generator.autocreate.db.TableFactory;
import com.pengji.component.generator.autocreate.template.CRUD;
import com.pengji.component.generator.autocreate.template.model.FormType;
import com.pengji.component.generator.autocreate.template.model.InputType;
import com.pengji.component.generator.autocreate.template.model.ModelAttr;
...
public class DbUtils {
		...
		if (columnNames.length >= 2) {
			...
			if (StrUtils.isNotEmpty(operateName)) {
				...
				for (int i = 0; i < operateName.length(); i++) {
					int tmpOper = ("0".equals(String.valueOf(operateName.charAt(i)))) ? 0 : 1;
					operate += Math.pow(2, operateName.length()-1-i) * tmpOper;
				}
	...
	public static void main(String[] args) {
		System.out.println(FormType.DICT.toString());
		System.out.println("dict".equals(FormType.DICT.toString()));
	}
