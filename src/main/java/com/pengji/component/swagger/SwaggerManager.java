...
import com.pengji.component.swagger.annotation.SwaggerDefinition;
import com.pengji.component.swagger.annotation.SwaggerParam;
import com.pengji.component.swagger.annotation.SwaggerResponse;
...
public class SwaggerManager {
    ...
    private SwaggerConfig config = Config.config(SwaggerConfig.class);
    ...
    private void initSwagger() {
        ...
        for (Class controllerClass : classes) {
            ...
            for (Method method : methods) {
                ...
                String pathString = Config.getPathByController(controllerClass) + methodPath;
