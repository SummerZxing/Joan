...
public class SQLUtils {
	...
	public void whereLike(String attrName, String value,String alias) {
		if (StrUtils.isNotEmpty(value)) {
			value = value.replaceAll("'", "");
			sqlBuffer.append(" AND " + getAttrName(attrName,alias) + " LIKE '%").append(value).append("%'");
		}
	}
	...
	public void whereEquals(String attrName, String value,String alias) {
		if (StrUtils.isNotEmpty(value)) {
			sqlBuffer.append(" AND " + getAttrName(attrName,alias) + " = '").append(value).append("'");
		}
	}
	
	public void whereEquals(String attrName, Integer value,String alias) {
		if (value != null && value > 0) {
			sqlBuffer.append(" AND " + getAttrName(attrName,alias) + " = ").append(value);
		}
	}
	
	public void whereOr(String attrName1,String attrName2,Integer value1,Integer value2) {
		if (attrName1 != null && attrName1 != "" && attrName2 != null && attrName2 != "" && value1 != null && value1 > 0 && value2 != null && value2 > 0) {
			sqlBuffer.append(" AND (" + getAttrName(attrName1) + " = ").append(value1).append(" or " + getAttrName(attrName2) + " = ").append(value2).append(" )");
		}
	}
	...
	private String getAttrName(String attrName,String alias) {
		if (StrUtils.isEmpty(alias)) {
			return attrName;
		}
		return alias + "." + attrName;
	...
	public String toString() {
		...
		return sqlBuffer.append(" order by "+orderBy).toString();
	}
